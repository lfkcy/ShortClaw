...
import { getShortClawProviderStore } from '../services/providers/store-instance';
import {
 ...
 * Also synchronizes ShortClaw local provider list with OpenClaw's actual config.
 */
...
> {
  ...
  for (const provider of providers) {
    ...
    // we should remove it from ShortClaw UI to stay consistent.
